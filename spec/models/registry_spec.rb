...
RSpec.describe Registry, type: :model do
  ...
  let!(:list) { Registry.create(title: 'Coat Drive', description: "We're collecting coats for the community, we appreciate all your help as it goes toward keeping members of our community warm.", deadline:'(2018, 2, 3)', user_id: user.id)}
